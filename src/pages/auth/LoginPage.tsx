      ...
      <>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3">
            <Button variant="ghost" className="w-full border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700" onClick={() => handleOAuthLogin('google')} isLoading={isLoading} aria-label="Logga in med Google">
              <GoogleIcon /> Logga in med Google
            </Button>
            <Button variant="ghost" className="w-full border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700" onClick={() => handleOAuthLogin('microsoft')} isLoading={isLoading} aria-label="Logga in med Microsoft">
              <MicrosoftIcon /> Logga in med Microsoft
            </Button>
            <Button variant="ghost" className="w-full border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700" onClick={() => handleOAuthLogin('apple')} isLoading={isLoading} aria-label="Logga in med Apple">
              <AppleIcon /> Logga in med Apple
            </Button>
          </div>
        </div>
      </>
