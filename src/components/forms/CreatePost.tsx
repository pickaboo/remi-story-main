        ...
        <div className="flex justify-between items-center pt-3 border-t border-border-color dark:border-slate-700">
          <div className="flex gap-2">
            ...
            {imagePreviewUrl ? (
              ...
              >
                <span className="flex flex-col items-center justify-center w-24">
                  <TrashIcon />
                  <span className="text-center">Ta bort vald bild</span>
                </span>
              </Button>
            ) : (
              <Button 
              ...
              >
                <span className="flex flex-col items-center justify-center w-24">
                  <UploadIcon />
                  <span className="text-center">Ladda upp bild</span>
                </span>
              </Button>
            )}
            ...
            {!imagePreviewUrl && ( 
                ...
                >
                  <span className="flex flex-col items-center justify-center w-24">
                    <ImageBankIcon />
                    <span className="text-center">Bildbank</span>
                  </span>
                </Button>
            )}
          </div>
